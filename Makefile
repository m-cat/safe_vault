...
package-commit_hash-artifacts-for-deploy:
	...
	rm -rf deploy
	mkdir deploy
	tar -C artifacts/prod/x86_64-unknown-linux-musl/release -cvf safe_vault-$$(git rev-parse --short HEAD)-x86_64-unknown-linux-musl.tar safe_vault
	tar -C artifacts/prod/x86_64-pc-windows-gnu/release -cvf safe_vault-$$(git rev-parse --short HEAD)-x86_64-pc-windows-gnu.tar safe_vault.exe
	tar -C artifacts/prod/x86_64-apple-darwin/release -cvf safe_vault-$$(git rev-parse --short HEAD)-x86_64-apple-darwin.tar safe_vault
